...
export function CharacterSheet({ characterId }: CharacterSheetProps) {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-amber-50">
        <div className="text-amber-900 text-lg">Loading character...</div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-amber-50 p-4 md:p-8">
      <div className="max-w-6xl mx-auto bg-[#f5f0e8] rounded-lg shadow-2xl border-4 border-amber-800 overflow-hidden">
        {/* Save indicator */}
        {saving && (
        ...
        <div className="p-6 md:p-8">
          ...
          <div className="grid grid-cols-3 gap-4 mb-8">
            <div className="bg-amber-100 border-2 border-amber-700 rounded-lg p-4">
              <div className="text-sm font-semibold text-amber-900 mb-2 text-center">
                Level
              </div>
              <div className="flex items-center justify-center gap-2">
                <button
                  onClick={() => adjustStat('level', -1)}
                  className="w-8 h-8 bg-amber-600 hover:bg-amber-700 text-white rounded font-bold"
                >
                  −
                </button>
                <div className="text-2xl font-bold text-amber-900 min-w-[3rem] text-center">
                  {character.level}
                </div>
                <button
                  onClick={() => adjustStat('level', 1)}
